...
const ChatViewWA = (props: any) => {
    const { text, buttons, buttonsInline } = props;
    return (
        <div className="wa-root page">
                            ...
                            <div className="chat-container">
                                ...
                                <div className="conversation">
                                    <div className="conversation-container">
                                        ...
                                        <div className="message received buttons">
                                    ...
                                    <form className="conversation-compose-all">
